...
public class Atlas extends Carte{
    ...
    public Atlas(int idCarte, String titlu, String autor, boolean imprumutata, String editura) {
        super(idCarte, titlu, autor, imprumutata);
        this.editura = editura;
    }

    public Atlas(int nCarti, String titlu, String autor, String editura) {
        super(nCarti, titlu, autor);
        this.editura = editura;
    }
